    ...
    days: {
        1: {
            ...
            sections: {
                "Travel & Morning": [
                    ...
                    { name: "Terminal 21 Pattaya", start: "01:30 PM", end: "02:30 PM", hours: "11:00 AM - 10:00 PM", dur: "1 hr", cost: 200, famous: "Airport Theme Mall", see: "Different world cities on every floor (Paris, Tokyo, etc.).", do: "Eat cheap and delicious food at the Pier 21 food court.", map: "Terminal+21+Pattaya", transport: "Bolt Ride (100 THB)", img: "https://images.unsplash.com/photo-1519567770579-c2fc5436bcf9?q=80&w=800" }
                ],
                "Activities": [
                    ...
                    { name: "Pado Media Art Space", start: "05:00 PM", end: "06:30 PM", hours: "10:00 AM - 09:00 PM", dur: "1.5 hrs", cost: 599, famous: "Immersive Digital Art", see: "Spectacular light and sound digital exhibitions across multiple zones.", do: "Immerse yourself in interactive media art.", book: "Klook", map: "Pado+Media+Art+Space+Pattaya", transport: "Bolt Ride (100 THB)", img: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=800" }
                ],
                "Food": [
        ...
        2: {
            ...
            sections: {
                ...
                "Activities": [
                    { name: "Nong Nooch Garden", start: "01:30 PM", end: "04:00 PM", hours: "08:00 AM - 06:00 PM", dur: "2.5 hrs", cost: 500, famous: "Massive Botanical Park", see: "Incredible dinosaur valley and themed gardens.", do: "Walk through the French gardens and see the cultural show.", book: "Klook", map: "Nong+Nooch+Tropical+Garden", img: "https://images.unsplash.com/photo-1588628566587-bf5c302cb4bb?q=80&w=800" },
                    { name: "Art in Paradise", start: "04:30 PM", end: "05:30 PM", hours: "09:00 AM - 09:00 PM", dur: "1 hr", cost: 500, famous: "3D Visuals", see: "Immersive 3D paintings that come to life on camera.", do: "Take creative photos in the various themed zones.", book: "Klook", map: "Art+in+Paradise+Pattaya", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=800" },
                    { name: "Big Buddha Hill", start: "05:30 PM", end: "06:15 PM", hours: "08:00 AM - 06:00 PM", dur: "45 min", cost: 0, famous: "Golden Landmark", see: "18m Golden Buddha and panoramic Pattaya views.", do: "Climb the grand stairs.", map: "Wat+Phra+Yai+Pattaya", img: "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?q=80&w=800" },
                    { name: "Pattaya View Point", start: "06:15 PM", end: "07:00 PM", hours: "07:00 AM - 10:00 PM", dur: "45 min", cost: 0, famous: "Cityscape Panorama", see: "The best panoramic view of Pattaya's crescent bay.", do: "Enjoy the sunset golden hour over the city and sea.", map: "Pattaya+City+Sign+Viewpoint", img: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?q=80&w=800" },
